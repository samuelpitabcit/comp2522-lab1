...
public class BankClient
{
    ...
    {
        return clientname.getFullName() + " client #" + clientID + " (" + (isAlive() ? "alive" : "died") + ") joined " +
            "the bank on " + signupDate.getWeekdayAsString().toLowerCase() + ", " + formatMonth(signupDate.getMonth()) + " " + signupDate.getDay() + ", " + signupDate.getYear();
    }
